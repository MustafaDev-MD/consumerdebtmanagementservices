...
<!-- <div class="breadcrumb-section">
    <div class="container">
        <h1> Credit Card Debt Forgiveness </h1>
        <div class="breadcrumb">
            <a href="{{ route('home') }}"> Home </a>
            <a href="{{ route('resources') }}"> Resources </a>
            <a href="{{ route('resources') }}"> Credit Card Debt Relief </a>
            <span class="current"> Credit Card Debt Forgiveness </span>
        </div>
    </div>
</div> -->
...
<section id="primary" class="content-full-width">
    ...
    <div class="container">
        ...
        <div class="dt-sc-two-third column first">
            <h1 class="dt-sc-simple-hr-title"> Credit Card Debt Forgiveness </h1>
            <!-- <div class="flex">
            ...
            <ul class="dt-sc-fancy-list chocolate check-circle">
                ...
                <li>Providers often cancel segments of your balance if you offer a single payment.</li>
                <li>Approval requires demonstrating that fulfilling your full dues creates a significant struggle.</li>
                <li>Lenders frequently grant partial forgiveness on unsecured personal loans to close out the account.</li>
                <li>Government programs occasionally allow for forgiveness options on student loans under specific criteria.</li>
                <li>Asset-backed obligations like home or vehicle loans rarely qualify for any reduction.</li>
            </ul>
            <p>
...
<section class="faq-sticky-wrapper">
    <div class="container">
        ...
        <div class="dt-sc-two-third column first" id="mainContent">
            ...
            <div id="debt-forgiveness—gains-and-risks" class="content-block scroll-section">
                <h2 class="highlight-box">Debt forgiveness—Gains and Risks</h2>
        ...
        <div class="dt-sc-one-third column faq-sidebar-col">
            <div class="toc-box" id="tocBox">
                ...
                <ul class="toc">
                    <li><a href="#which-debt-categories-qualify-regarding-forgiveness" class="toc-link">Which debt categories qualify regarding forgiveness?</a></li>
                    <li><a href="#defining-credit-card-debt-forgiveness" class="toc-link">Defining credit card debt forgiveness</a></li>
                    <li><a href="#processes-pertaining-to-credit-card-debt-forgiveness" class="toc-link">Processes pertaining to credit card debt forgiveness</a></li>
                    <li><a href="#in-what-ways-do-debt-forgiveness-plus-debt-settlement-diverge" class="toc-link">In what ways do debt forgiveness plus debt Settlement Diverge?</a></li>
                    <li><a href="#debt-forgiveness—gains-and-risks" class="toc-link">Debt forgiveness—Gains and Risks</a></li>
                </ul>
